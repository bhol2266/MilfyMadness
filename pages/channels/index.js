            ...
            <div className='basicMargin'>
                ...
                <div className={` mt-4  transition ease-in-out delay-150 `}>
                    <div className='flex my-1  md:w-3/5 md:mx-auto p-2 px-3  border-[1px] border-gray-100 space-x-2 md:space-x-4 xl:px-[50px] rounded-[15px]'  >
                        ...
                        <input className='focus:outline-none flex-grow text-white  font-inter rounded-lg bg-transparent' type='text' onChange={(event) => { onChangeHandler(event.target.value) }} placeholder='Search channel...'></input>
                    </div>
                </div>
                            ...
                            <Link key={obj.channelName} href={href}>
                                <div className='  relative hover:scale-105 transform transition duration-150 rounded   aspect-box  ' >
                                    <img
                                        ...
                                        loading="lazy"
                                    ></img>
                                    <h2 className='mt-1 font-inter rounded-b font-medium  text-[12px]  sm:text-md lg:text-lg 2xl:text-2xl  px-1  pb-3 lg:pb-4 w-full text-center   text-theme_text '>{obj.channelName}</h2>
                                </div>
                            </Link>
