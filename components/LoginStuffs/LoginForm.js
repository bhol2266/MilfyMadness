    ...
    return (
        ...
        <div className="relative bg-semiblack  rounded-lg  px-6  py-10  ">
            ...
            <div className="flex flex-col justify-center">
                ...
                <p className='mb-6 font-inter text-gray-300 text-center text font-dancing text-ll'>Unleash your desires!   </p>


                <div className="">
                    <form className="space-y-5" action="#" method="POST" onSubmit={handleSubmit}>
                        <div className=''>
                            <label htmlFor="email" className="text-sm font-medium leading-6 text-gray-300 pl-1">Email address</label>
                            <div className="mt-1">
                                <input
                                    id="email"
                                    name="email"
                        ...
                        <div className='  '>
                            <label htmlFor="password" className="text-sm font-medium leading-6 text-gray-300 pl-1">Password</label>
                            <div className="mt-1">
                                <input
                                    id="password"
                                    name="password"
                        ...
                        <button type="submit" className="relative mt-[20px] flex w-full h-[40px] justify-center items-center space-x-1 rounded-md bg-gray-200 px-3 py-1.5 shadow-sm ">
                            ...
                            {!loading && <CiLogin className="text-gray-300 text-xl mt-1" />}

                            {!loading && <p className=" text-sm font-inter leading-6 text-gray-300 font-inter font-semibold mt-1">Login</p>}
                        </button>
                    ...
                    <p onClick={() => { setPasswordResetVisible(true); setLoginFormVisible(false) }} className="cursor-pointer mt-6 mb-2 text-center text-sm text-gray-300">
